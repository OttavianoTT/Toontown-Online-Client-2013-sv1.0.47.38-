...
class OTPClientRepository(ClientRepositoryBase):
    ...
    def __init__(self, serverVersion, launcher = None, playGame = None):
        ...
        self.toonsanityChatManager = None
 ...
 'backArgs': []}):
    ...
    def _requestAvatarList(self):
        self.clientManager.requestAvatars()
    ...
    def sendSetAvatarIdMsg(self, avId):
        if avId != self.__currentAvId:
            ...
            self.clientManager.sendChooseAvatar(avId)
            if avId == 0:
    ...
    def handleGenerateWithRequired(self, di, other = False):
        ...
        for handle, interest in self._interests.items():
            ...
            interest = None
            self.notify.warning('Received generate for {0} from {1}:{2}, not part of any existing interest!'.format(doId, parentId, zoneId))
