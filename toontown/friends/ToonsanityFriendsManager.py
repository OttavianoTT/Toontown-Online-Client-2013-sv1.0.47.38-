...
class ToonsanityFriendsManager(DistributedObjectGlobal):
    notify = directNotify.newCategory('ToonsanityFriendsManager')
    ...
    def avatarDetailsResp(self, avId, details):
        ...
        for currentField in fields:
            if currentField[0] in ('setExperience', 'setInventory', 'setDNAString', 'setMailboxContents', 'setAwardMailboxContents', 'setGiftSchedule', 'setDeliverySchedule', 'setAwardSchedule'):
