...
class DistributedFurnitureManagerAI(DistributedObjectAI):
    ...
    def moveItemFromAtticMessage(self, index, x, y, z, h, p, r, context):
        ...
        taskMgr.doMethodLater(1, self.sendUpdateToAvatarId, self.uniqueName('send-attic-response'), extraArgs = [avId, 'moveItemFromAtticResponse', [ToontownGlobals.FM_MovedItem, obj.doId, context]])
