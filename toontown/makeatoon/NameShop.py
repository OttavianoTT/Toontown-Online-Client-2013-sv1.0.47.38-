...
class NameShop(StateData.StateData):
    ...
    def checkNamePattern(self):
        ...
        base.cr.clientManager.sendSetNamePattern(self.avId,
    ...
    def checkNameTyped(self, justCheck = False):
        ...
        if justCheck:
            ...
            avId = self.avId
        base.cr.clientManager.sendSetNameTyped(avId, self.nameEntry.get(), self.handleSetNameTypedResp)
        self.waitForServer()
    ...
    def serverCreateAvatar(self, skipTutorial = False):
        ...
        if not self.avExists or self.avExists and self.avId == 'deleteMe':
            base.cr.clientManager.sendCreateAvatar(style, '', self.index)
