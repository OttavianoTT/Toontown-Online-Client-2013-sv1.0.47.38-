...
class ToontownClientRepository(OTPClientRepository.OTPClientRepository):
    ...
    def __handleCongrats(self, avatarChoice):
        ...
        self.clientManager.sendAcknowledgeAvatarName(avatarChoice.id, lambda: self.loginFSM.request('waitForSetAvatarResponse', [avatarChoice]))
    ...
    def __handleReject(self, avList, index):
        ...
        self.clientManager.sendAcknowledgeAvatarName(avid, lambda: self.loginFSM.request('waitForAvatarList'))
    ...
    def __sendGetAvatarDetails(self, avId):
        self.toonsanityFriendsManager.d_getAvatarDetails(avId)
    ...
    def removeFriend(self, avatarId):
        ...
        self.toonsanityFriendsManager.d_removeFriend(avatarId)
    ...
    def sendGetFriendsListRequest(self):
        ...
        self.friendsListError = 0
        self.toonsanityFriendsManager.d_getFriendsListRequest()
    ...
    def requestAvatarInfo(self, avId):
        if avId == 0:
            return
        self.toonsanityFriendsManager.d_requestAvatarInfo([avId])
    ...
    def sendAvatarInfoRequests(self, task = None):
        ...
        if len(self.avatarInfoRequests) == 0:
            return
        self.toonsanityFriendsManager.d_requestAvatarInfo(self.avatarInfoRequests)
