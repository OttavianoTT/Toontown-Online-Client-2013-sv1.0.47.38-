...
class ToonsanityChatManagerUD(DistributedObjectGlobalUD):
    notify = directNotify.newCategory('ToonsanityChatManagerUD')
    ...
    def chatMessage(self, message):
        ...
        def handleAvatar(dclass, fields):
            ...
            datagram = do.aiFormatUpdate('setTalk', avId, avId, self.air.ourChannel, [avId, accId, senderName, filteredMessage, modifications, 0])
    ...
    def whisperMessage(self, message, receiverAvId):
        ...
        def handleAvatar(dclass, fields):
            ...
            do = self.air.dclassesByName['DistributedAvatarUD']
            datagram = do.aiFormatUpdate('setTalkWhisper', receiverAvId, receiverAvId, self.air.ourChannel, [avId, accId, senderName, filteredMessage, modifications, 0])
            self.air.send(datagram)
